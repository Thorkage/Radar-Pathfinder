...
*Pathfinder* is presented in detail in a publication in prep which is aimed for submission towards the end of 2025. To get started with using Pathfinder, have a look at the *running_Pathfinder.ipynb* and *make_RADAR.ipynb* notebooks. All relevant information should be there. If any questions arise: Let me know. In /Data/Snowdrone we provide a subset of UWiBaSS, Magnaprobe (https://doi.org/10.21334/NPOLAR.2024.3BB72EB0) and snow profile data (unpublised, pit examined by Robbie Mallet, UiT) from one of the 2024 surveys on Svalbard. 
